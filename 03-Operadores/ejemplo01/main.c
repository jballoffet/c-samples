...
int main(void)
{
    ...
    // Realizo varias operaciones aritmeticas e imprimo el resultado en
    // pantalla.
    ...
    // ¿Y si quiero el resultado como un numero real? Debo castear! (¡Castear
    // antes de realizar la operacion!) ¡Asi no!
    d = (float)(a / b);
