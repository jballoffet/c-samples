/*!
 * @file   main.c
 * @brief  11. Arreglos Multidimensionales - 03. Inicialización de arreglos multidimensionales (sin indicar largo)
...
int main() {
  // Declaro un arreglo multidimensional (2D array) de enteros (int) de 2x3 elementos e inicializo el arreglo (no es necesario indicar la cantidad de elementos de la primera dimension).
