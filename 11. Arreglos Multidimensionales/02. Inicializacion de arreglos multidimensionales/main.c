/*!
 * @file   main.c
 * @brief  11. Arreglos Multidimensionales - 02. Inicialización de arreglos multidimensionales
...
int main() {
  // Declaro un arreglo multidimensional (2D array) de enteros (int) de 2x3 elementos e inicializo el arreglo.
