/*!
 * @file   main.c
 * @brief  11. Arreglos Multidimensionales - 10. Pasaje de un arreglo multidimensional a una función (usando punteros)
...
float average(int* array2D_pointer, int rows, int columns) {
  ...
  // Recorro el arreglo recibido, sumando el valor de todos los elementos y luego calculo el promedio.
  for (i = 0; i < rows; i++) {
    for (j = 0; j < columns; j++) {
