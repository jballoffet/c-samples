/*!
 * @file   main.c
 * @brief  04. Estructuras de Control - Decisión - 05. Estructura 'if-else' con condiciones múltiples
...
int main() {
  ...
  // Informo por pantalla si ambos números ingresados son negativos, positivos o cero.
