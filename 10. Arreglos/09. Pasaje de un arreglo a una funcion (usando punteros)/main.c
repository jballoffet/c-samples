/*!
 * @file   main.c
 * @brief  10. Arreglos - 09. Pasaje de un arreglo a una función (usando punteros)
...
float average(int* array_pointer, int length) {
  ...
  // Recorro el arreglo usando el puntero recibido, sumando el valor de todos los elementos y luego calculo el promedio.
  for (i = 0; i < length; i++) {
    sum += *(array_pointer + i);
  }
