/*!
 * @file   main.c
 * @brief  07. Funciones - Archivos Header - 03. Variables globales y globales (al módulo)
...
// Declaro la variable "number2" como global (al módulo main.c).
static int number2 = 10;

int main() {
  // Invoco a "increment" y muestro el valor de "number1" antes y después de llamar a la función.
