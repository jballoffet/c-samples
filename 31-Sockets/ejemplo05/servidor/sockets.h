 ...
 * @return    Descriptor del socket servidor en caso de éxito, o código de error
 * en caso contrario.
 */
 ...
 * @return     Descriptor del socket cliente en caso de éxito, o código de error
 * en caso contrario.
 */
 ...
 * @return    Descriptor del socket en caso de éxito, o código de error en caso
 * contrario.
 */
